...
const String _fontFamily = 'Monaco';
...
class SyntaxHighlighterStyle {
  ...
  static SyntaxHighlighterStyle lightThemeStyle() {
    return SyntaxHighlighterStyle(
      baseStyle:
          const TextStyle(color: Colors.black87, fontFamily: _fontFamily),
      numberStyle:
          const TextStyle(color: Color(0xFF990055), fontFamily: _fontFamily),
      commentStyle:
          const TextStyle(color: Color(0xFF708090), fontFamily: _fontFamily),
      keywordStyle:
          const TextStyle(color: Color(0xFF0077aa), fontFamily: _fontFamily),
      stringStyle:
          const TextStyle(color: Color(0xFF43A047), fontFamily: _fontFamily),
      punctuationStyle:
          const TextStyle(color: Color(0xFF999999), fontFamily: _fontFamily),
      classStyle:
          const TextStyle(color: Color(0xFFdd4a68), fontFamily: _fontFamily),
      constantStyle:
          const TextStyle(color: Color(0xFF795548), fontFamily: _fontFamily),
    );
  }
  ...
  static SyntaxHighlighterStyle darkThemeStyle() {
    return SyntaxHighlighterStyle(
      baseStyle:
          const TextStyle(color: Color(0xFFFFFFFF), fontFamily: _fontFamily),
      numberStyle:
          const TextStyle(color: Color(0xFF1565C0), fontFamily: _fontFamily),
      commentStyle:
          const TextStyle(color: Color(0xFF9E9E9E), fontFamily: _fontFamily),
      keywordStyle:
          const TextStyle(color: Color(0xFF80CBC4), fontFamily: _fontFamily),
      stringStyle:
          const TextStyle(color: Color(0xFF009688), fontFamily: _fontFamily),
      punctuationStyle:
          const TextStyle(color: Color(0xFFFFFFFF), fontFamily: _fontFamily),
      classStyle:
          const TextStyle(color: Color(0xFF009688), fontFamily: _fontFamily),
